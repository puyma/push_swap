...
/*   Updated: 2023/04/03 12:58:04 by mpuig-ma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_do_instruction(t_data *data, char *str)
{
	...
	else if (ft_strncmp(str, "sa", 2) == 0)// || ft_strncmp(str, "ss", 2) == 0)
		swap(data->a, 0);
	...
	else if (ft_strncmp(str, "rra", 3) == 0)// || ft_strncmp(str, "rrr", 3) == 0)
		rev_rotate(data->a, 0);
	else if (ft_strncmp(str, "rrb", 3) == 0)// || ft_strncmp(str, "rrr", 3) == 0)
		rev_rotate(data->b, 0);
	...
	else if (ft_strncmp(str, "ra", 2) == 0)//|| ft_strncmp(str, "rr", 2) == 0)
		rotate(data->a, 0);
	else if (ft_strncmp(str, "rb", 2) == 0)//|| ft_strncmp(str, "rr", 2) == 0)
		rotate(data->b, 0);
